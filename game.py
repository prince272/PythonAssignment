...
pygame.display.set_caption("Hangman Game! BY PRINCE OWUSU")
...
buttons = []
guessed = []
hangmanPics = [pygame.image.load('images/hangman0.png'), pygame.image.load('images/hangman1.png'), pygame.image.load('images/hangman2.png'),
               pygame.image.load('images/hangman3.png'), pygame.image.load('images/hangman4.png'), pygame.image.load('images/hangman5.png'),
